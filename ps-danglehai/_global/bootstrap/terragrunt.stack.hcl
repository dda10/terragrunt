...
stack "bootstrap" {
  ...
  values = {
    ...
    github_org_name  = "dda10"
    github_repo_name = "terragrunt"
    deploy_branch = "main"
    ...
    // =========================================================================
    oidc_provider_import_arn = "arn:aws:iam::434481793703:oidc-provider/token.actions.githubusercontent.com"
    plan_iam_role_import_existing = true
    plan_iam_policy_import_arn = "arn:aws:iam::434481793703:policy/pipelines-plan"
    plan_iam_role_policy_attachment_import_arn = "pipelines-plan/arn:aws:iam::434481793703:policy/pipelines-plan"
    apply_iam_role_import_existing = true
    apply_iam_policy_import_arn = "arn:aws:iam::434481793703:policy/pipelines-apply"
    apply_iam_role_policy_attachment_import_arn = "pipelines-apply/arn:aws:iam::434481793703:policy/pipelines-apply"
    // =========================================================================
